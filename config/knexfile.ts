...
const knexConfig: DatabaseConfig = {
  ...
  connection: {
    ...
    connectionTimeoutMillis: Math.trunc(Number(process.env.DB_CONNECTION_TIMEOUT_MILLIS)) || 10000,
    statementTimeoutMillis: Math.trunc(Number(process.env.DB_STATEMENT_TIMEOUT_MILLIS)) || 10000
  },
  migrations: {
